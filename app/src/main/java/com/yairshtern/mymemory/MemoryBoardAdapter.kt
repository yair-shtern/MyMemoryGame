...
import com.yairshtern.mymemory.models.MemoryCard
...
class MemoryBoardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val cardWidth = parent.width / boardSize.getWidth(orientation) - (2 * MARGIN_SIZE)
        val cardHeight = parent.height / boardSize.getHeight(orientation) - (2 * MARGIN_SIZE)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            imageButton.setOnClickListener {
                Log.i(TAG, "Clicked op position $position")
